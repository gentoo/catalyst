...
snapshot: 20040330
source_subpath: default/livecd-stage1-sparc-20040330
livecd/cdfstype: zisofs
livecd/archscript: examples/livecd/runscript/sparc-archscript.sh
...
boot/kernel/gentoo/config: examples/livecd/sparc/config-2.4.25-sparc-up
...
boot/kernel/gentoo-smp/config: examples/livecd/sparc/config-2.4.25-sparc-smp
